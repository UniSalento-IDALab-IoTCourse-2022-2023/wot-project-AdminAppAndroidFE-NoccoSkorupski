...
public class MappaPABeaconActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new MappaPABeaconActivity.FetchDataTask().execute();
            ...
            if (result != null) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        View separator = new View(MappaPABeaconActivity.this);
