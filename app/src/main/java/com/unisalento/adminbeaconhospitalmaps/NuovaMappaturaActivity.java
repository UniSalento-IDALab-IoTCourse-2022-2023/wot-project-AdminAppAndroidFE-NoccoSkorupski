...
public class NuovaMappaturaActivity extends AppCompatActivity {
    ...
    public void submitForm(View view) {
        ...
        String url = "http://ec2-52-22-228-41.compute-1.amazonaws.com:8081/api/amministratore/beaconMappato";
        ...
        try {
            ...
            mainObject.put("vicini", viciniArray);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        ...
        new PostDataTask(url, jsonString).execute();

    }
    private void showLongDurationToast(String message) {
        Toast toast = Toast.makeText(NuovaMappaturaActivity.this, message, Toast.LENGTH_LONG);
    ...
    private class PostDataTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                ...
                Toast.makeText(NuovaMappaturaActivity.this, "Errore durante la richiesta POST", Toast.LENGTH_SHORT).show();
            }
        }
    }
